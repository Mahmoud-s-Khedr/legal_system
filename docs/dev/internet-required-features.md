...
- Planned integrations such as MoJ portals, WhatsApp, ETA, Digital Egypt, and VLM OCR are not included because they are not currently implemented in active runtime code paths.
