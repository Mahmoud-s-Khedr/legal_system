...
vi.mock("../../components/shared/EnumBadge", () => ({
...
describe("ClientsPage", () => {
  it("renders serial and poa columns and omits email", () => {
    const view = render();

    expect(view.textContent).toContain("labels.internalRef");
    expect(view.textContent).toContain("labels.poaNumber");
    expect(view.textContent).toContain("C-001");
    expect(view.textContent).toContain("POA-77");
    expect(view.textContent).not.toContain("labels.email");
  });
});
