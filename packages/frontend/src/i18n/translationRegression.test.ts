...
const criticalKeys: Array<{ ns: Namespace; key: string }> = [
  ...
  { ns: "app", key: "errors.backend.validationFailed" },
  { ns: "app", key: "errors.backend.duplicateEmail" },
  { ns: "app", key: "errors.backend.duplicateRoleKey" },
  { ns: "app", key: "roles.validation.permissionRequired" },
  { ns: "app", key: "roles.roleKeyPlaceholder" },
  { ns: "app", key: "users.seatLimitReached" },
